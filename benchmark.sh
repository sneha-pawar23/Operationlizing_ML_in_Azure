...
# Total:        114  160  28.0    172     199#
 ...
 ab -n 10 -v 4 -p data.json -T 'application/json' -H 'Authorization: Bearer n7tWHDydoWMWdhByWRtqOBcngZxZP8fI' http://4035fac9-b8bf-4582-b658-726c628c5a01.southcentralus.azurecontainer.io/score
